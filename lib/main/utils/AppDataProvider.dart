...
import 'package:mighty_ui_kit/widgets/materialAppWidget/MTInformationDisplayWidget/MWBannerSliderWidget/MWBannerSliderScreen1.dart';
import 'package:mighty_ui_kit/widgets/materialAppWidget/MTInformationDisplayWidget/MWBannerSliderWidget/MWBannerSliderScreen2.dart';
...
List<AppModel> getCodeSnippetsList() {
  ...
  list.add(AppModel(
      ...
      description: 'Save and Read SharedPreferences',
      widget: SharedPreferenceScreen()));
...
List<AppModel> getFullAppsList() {
  ...
  list.add(AppModel(
      title: 'NFTs',
      description: 'Non Fungible Token App',
      widget: NFSplashScreen(),
  ...
  list.add(AppModel(
      title: 'IIumia Crypto',
      description: 'IIumia Crypto Coin',
      widget: ICSplashScreen(),
      isDarkModeSupported: true,
      themeType: ThemeTypeFullApp));
  list.add(AppModel(
      title: 'ECommerce',
      description: 'We’re in Business to Improve Lives',
      widget: ECSplashScreen(),
      isDarkModeSupported: true,
      themeType: ThemeTypeFullApp));
  list.add(AppModel(
      title: 'News Blog',
      description: 'Improve news knowledge',
      widget: NBSplashScreen(),
      isDarkModeSupported: true,
      themeType: ThemeTypeFullApp));
  list.add(AppModel(
      title: 'Fitness App',
      description: 'Improve your Fitness Today',
      widget: FTSplashScreen(),
      isDarkModeSupported: true,
      themeType: ThemeTypeFullApp));
  list.add(AppModel(
      title: 'Yoga',
      description: 'Learnt Yoga Online',
      widget: YGSplashScreen(),
      isDarkModeSupported: true,
      themeType: ThemeTypeFullApp));
  list.add(AppModel(
      title: 'Finance',
  ...
  list.add(AppModel(
      title: 'Food Delivery',
      description: 'The Best Shopping app for all your grocery.',
      widget: FDSplashScreen(),
      isDarkModeSupported: false,
      themeType: ThemeTypeFullApp));
  list.add(AppModel(
      title: 'Grocery',
      description: 'The Best Shopping app for all your grocery.',
      widget: GSSplashScreen(),
      isDarkModeSupported: true,
      themeType: ThemeTypeFullApp));
  list.add(AppModel(
      title: 'eGarden',
      description: 'Garden Shopping App',
      widget: EGSplashScreen(),
      isDarkModeSupported: false,
      themeType: ThemeTypeFullApp));
  list.add(AppModel(
      title: 'Handy Man',
      description: 'Home Service partner App',
      widget: HMWalkThroughScreen(),
      isDarkModeSupported: false,
      themeType: ThemeTypeFullApp));
  list.add(AppModel(
      title: 'Smart Home',
      description: 'Control your smart home devices',
      widget: HSSplashScreen(),
      isDarkModeSupported: false,
      themeType: ThemeTypeFullApp));
  list.add(AppModel(
      title: 'Rent House',
      description:
          'Use your smartphone to search rent home, apartment for rent nearby you.',
      widget: RHSplashScreen(),
      isDarkModeSupported: false,
      themeType: ThemeTypeFullApp));
  list.add(AppModel(
      title: 'VPN',
      description: 'Make your network secure and private',
      widget: VPNSplashScreen(),
      isDarkModeSupported: true,
      themeType: ThemeTypeFullApp));
  list.add(AppModel(
      title: 'Meela Bank',
      description: 'Control your smart home devices',
      widget: MBSplashScreen(),
      isDarkModeSupported: true,
      themeType: ThemeTypeFullApp));
