    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          8.width,
          Text(cardNumber!, style: boldTextStyle(size: 16, color: selectedIndex == mainIndex ? white : Colors.black)).expand(),
...
class CommonCategoryContainer extends StatefulWidget {
  ...
  CommonCategoryContainer({required this.recommendedList, required this.appBarTitle});
          ...
          return InkWell(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  commonCacheImageWidget(data.image, 130, width: 160, fit: BoxFit.cover).cornerRadiusWithClipRRectOnly(topRight: 6, topLeft: 6).expand(),
                  8.height,
                  Container(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(data.catName!, style: boldTextStyle(), overflow: TextOverflow.ellipsis),
                        4.height,
                        Text("\$${data.startingPrice} - \$${data.endingPrice}", style: boldTextStyle(color: HMFontColor400)),
                      ],
                    ),
                  ).paddingLeft(8),
                ],
...
class CommonSubCategoryContainer extends StatefulWidget {
  ...
  CommonSubCategoryContainer({required this.categoryData, required this.appBarTitle});
      ...
      child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            return InkWell(
                ...
                highlightColor: white,
                onTap: () {
                  HMAllCategoryData(appBarTitle: widget.appBarTitle).launch(context);
                },
                child: Container(
                  decoration: boxDecorationDefault(),
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      commonCacheImageWidget(widget.categoryData[index].image, 100, width: 160, fit: BoxFit.cover).cornerRadiusWithClipRRectOnly(topLeft: 8, topRight: 8),
                      Container(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Divider(thickness: 1, height: 0, color: appStore.isDarkModeOn ? appBarBackgroundColor : Theme.of(context).dividerColor),
...
class CommonOptionData extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: boxDecorationDefault(color: selectedIndex == mainIndex ? hmColorPrimary : appStore.cardColor, borderRadius: BorderRadius.circular(HMCornerRadius)),
      ...
      child: icon != null
          ? Row(
              ...
              children: [
                icon!,
                8.width,
                Text(optionData!, style: boldTextStyle(size: 16, color: selectedIndex == mainIndex ? Colors.white : null), overflow: TextOverflow.ellipsis),
              ],
            )
          : Text(optionData!, style: boldTextStyle(size: 16, color: selectedIndex == mainIndex ? Colors.white : null), overflow: TextOverflow.ellipsis).center(),
    );
  }
}
