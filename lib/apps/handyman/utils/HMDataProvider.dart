...
List<BookAppointmentQuestion> bookAppQuestion = [
  ...
  BookAppointmentQuestion(
      ...
      option: [ListOfOption(listOption: "Residential", icon: Icon(Icons.home_filled, color: Colors.green)), ListOfOption(listOption: "Commercial", icon: Icon(Icons.location_city_rounded, color: Colors.green))],
      hasOption: true),
  BookAppointmentQuestion(
  ...
  BookAppointmentQuestion(
      ...
      hasOption: true),
  BookAppointmentQuestion(question: "Do you need to be to site while the lawn professional is working?", option: [ListOfOption(listOption: "No, I don't need to be there"), ListOfOption(listOption: "Yes, i must be present")], hasOption: true),
