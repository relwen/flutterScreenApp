                ...
                child: CommonSinglePersonDetail(title: "Confirm Appointment", widgets: [
                  Column(
                    children: [
                      ...
                      Divider(thickness: 1, color: appStore.isDarkModeOn ? appBarBackgroundColor : Theme.of(context).dividerColor),
                      Row(
                        children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Text("Payment Methods", style: boldTextStyle(size: 18)).paddingOnly(left: 12, top: 8, bottom: 8).expand(),
                    ...
                    8.height,
                    Divider(thickness: 1, color: appStore.isDarkModeOn ? appBarBackgroundColor : Theme.of(context).dividerColor, height: 0),
                    ListView.builder(
                        shrinkWrap: true,
