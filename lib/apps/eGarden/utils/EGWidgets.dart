...
Widget roundedButtonWithoutFillColor({required BuildContext context, required String btnText}) {
  return Container(
...
Widget roundedButtonWithFillColor({required BuildContext context, required String btnText, bool isEnable = true}) {
  return Container(
    margin: EdgeInsets.all(4),
    height: 40,
    width: context.width(),
...
Widget btnWithoutFillColor({required String btnText}) {
  return Container(
    height: 40,
...
Widget btnWithFillColor({required String btnText}) {
  return Container(
    height: 40,
    padding: EdgeInsets.symmetric(horizontal: 16),
    alignment: Alignment.center,
...
Widget settingList({IconData? iconLeading, IconData? iconTrailing, required String title, String subtitle = ""}) {
  return Card(
    child: Container(
...
Widget settingListWithSwitch({Widget? trailing, required String title, String subtitle = ""}) {
  return Card(
    child: Container(
...
Widget settingListWithBoldTitle({IconData? iconLeading, required String title, String? subtitle}) {
  return Card(
    child: Container(
