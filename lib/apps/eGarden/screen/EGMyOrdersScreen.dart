...
class EGMyOrdersScreenState extends State<EGMyOrdersScreen> {
  ...
  late List<EGOrderPackageModel> listOfOrderDetails;
  late List<EGOrderPackageModel> listOfOrderPreparingAndShipping;
                            ...
                            children: [
                              Container(
                                ...
                                decoration: boxDecorationWithRoundedCorners(
                                  backgroundColor: listOfVoucher[index]['color'] as Color,
                                ...
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [Text(listOfVoucher[index]['percentage'] as String, style: boldTextStyle(size: 30, color: white)), 8.height, Text(listOfVoucher[index]['forWhat'] as String, style: boldTextStyle(size: 16, color: white))],
                                ),
                              ).expand(flex: 3),
                              Container(
                                height: 135,
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    4.height,
                                    Text(listOfVoucher[index]['date'] as String, style: boldTextStyle(size: 15)),
                                    8.height,
                                    Text(
