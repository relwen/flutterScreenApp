...
Widget commonButton({required BuildContext context, required String title}) {
  return Container(
    height: 50,
...
Widget commonDataList({required String title, Icon? icon, Widget? data}) {
  return Container(
    decoration: BoxDecoration(border: Border.all(color: commonBackBorderColor), borderRadius: BorderRadius.circular(10)),
    child: Row(
      children: [if (icon != null) IconButton(icon: icon, onPressed: null), Text(title, style: boldTextStyle(size: textSize.toInt(), color: commonColorWhite), overflow: TextOverflow.ellipsis).paddingAll(8).expand(), if (data != null) data],
    ).paddingAll(8).onTap(() {
      //
    }),
...
Widget commonListTile({required Icon icon, required String title}) {
  return Container(
    decoration: BoxDecoration(border: Border.all(color: commonBackBorderColor), borderRadius: BorderRadius.circular(10)),
    child: Row(
