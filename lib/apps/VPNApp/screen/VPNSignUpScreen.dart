                  ...
                  child: Column(
                    children: [
                      TextFormField(
                        ...
                        decoration: InputDecoration(enabledBorder: UnderlineInputBorder(borderSide: BorderSide(color: commonColorWhite)), labelStyle: boldTextStyle(color: commonColorWhite, size: 18), labelText: "Email Address"),
                        validator: (value) {
                          if (email == null) {
                      ...
                      TextFormField(
                          ...
                          style: TextStyle(fontSize: 18, color: commonColorWhite),
                          obscureText: true,
                          decoration: InputDecoration(enabledBorder: UnderlineInputBorder(borderSide: BorderSide(color: commonColorWhite)), labelStyle: boldTextStyle(color: commonColorWhite, size: 18), labelText: "Confirm Password"),
                          validator: (value) {
